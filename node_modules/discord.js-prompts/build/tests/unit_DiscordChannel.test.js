...
describe('Unit::DiscordChannel', () => {
    ...
    describe('sendMenuVisual', () => {
        ...
        it('throws when pagination is enabled but multiple messages were sent', () => __awaiter(void 0, void 0, void 0, function* () {
            const menuEmbed = new MenuEmbed_1.MenuEmbed();
            jest.spyOn(menuEmbed, 'canPaginate').mockReturnValue(true);
        ...
        it('uses the first message if array of messages is returned by discordjs', () => __awaiter(void 0, void 0, void 0, function* () {
            const menuEmbed = new MenuEmbed_1.MenuEmbed();
            jest.spyOn(menuEmbed, 'canPaginate').mockReturnValue(true);
            const setUpPagination = jest.spyOn(menuEmbed, 'setUpPagination')
                .mockImplementation();
