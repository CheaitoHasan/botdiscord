...
export declare abstract class Prompt<DataType, MessageType extends MessageInterface> {
     ...
     */
    sendVisual(visual: VisualInterface | VisualInterface[], channel: ChannelInterface<MessageType>): Promise<(MessageType | MessageType[])[] | MessageType>;
    /**
     ...
     */
    sendUserVisual(channel: ChannelInterface<MessageType>, data: DataType): Promise<(MessageType | MessageType[])[] | MessageType>;
    /**
     ...
     */
    run(channel: ChannelInterface<MessageType>, data: DataType): Promise<DataType>;
}
